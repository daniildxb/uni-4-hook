...
contract HookManagerTest is BaseTest {
    ...
    function test_hookManagement() public view {
        ...
        require(
            PoolId.unwrap(hookManager.hookToPoolId(address(hook))) == PoolId.unwrap(simplePoolId),
    ...
    function test_multipleHooksTracking() public {
        ...
        require(
            PoolId.unwrap(hookManager.hookToPoolId(secondHookAddress)) == PoolId.unwrap(secondPoolId),
